...
class CustomConfig(Config):
    ...
    NUM_CLASSES = 1 + 11  # Background + other classes
...
class CustomDataset(utils.Dataset):
    ...
    def load_custom(self, dataset_dir, subset):
        ...
        self.add_class("object", 6, "I")
        self.add_class("object", 7, "J")
        self.add_class("object", 8, "K")
        self.add_class("object", 9, "S")
        self.add_class("object", 10, "T")
        self.add_class("object", 11, "U")
        ...
        for a in annotations:
            ...
            name_dict = {"A": 1,"B": 2,"C": 3,"D":4,"E":5,"I":6,"J":7,"K":8,"S":9,"T":10,"U":11}
            # key = tuple(name_dict)
...
def train(model):
    ...
    dataset_train.load_custom("/content/kao-1", "train")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = CustomDataset()
    dataset_val.load_custom("/content/kao-1", "valid")
    dataset_val.prepare()
